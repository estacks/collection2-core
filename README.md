# estacks:collection2-core

Fork of [aldeed:collection2-core](https://github.com/aldeed/meteor-collection2-core) using a hard dependency of simpl-schema instead of ineffective NPM checks. 
...
```
$ meteor add estacks:collection2-core
```
